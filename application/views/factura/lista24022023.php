				...
				<div class="col-md-12">
					<table id="tbl_list" style="margin-left:-10px" class="table table-bordered table-list table-hover">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td> <h4>Total facturado anulado</h4></td>
							<td> <h3  style="text-align: right;"><?php echo number_format($t_f_a,2) ;?> </h3> </td>
						</tr>
						<tr>
							<td class="hidden-mobile"></td>
							<td></td>
							<td></td>
							<td> <h4>Total facturado autorizado</h4></td>
							<td><h3  style="text-align: right;"><?php echo number_format($t_f,2) ;?> </h3> </td>
						</tr>
						<tr>
							<td>
