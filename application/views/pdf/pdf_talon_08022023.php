    ...
    <tr>    
        <td width="48%" valign="bottom">
            <table id="encabezado1" width="100%">
                ...
                <tr>
                  <td colspan="2">Hora de autorizacion: 
                            <label style="font-weight: normal;">
                                <?php 
                                if ($factura->fac_fec_hora_aut==null) {
                                    $hora=date('h:i:s');
                                    echo $hora;
                                }else{
                                    $hora_aut = explode("T", $factura->fac_fec_hora_aut);
                                $hora = explode("-", $hora_aut[1]);
                                $h    = $hora[0];
                                echo $h;
                                }
            ...
            <table id="encabezado3" width="100%">
                <tr>
                   ...
                   $nombre= str_replace ( "Ñ" , "ñ" , $factura->fac_nombre )
                    ?>
                    <td><strong>  <?php echo 'Razón Social:' ?> </strong> <?php echo utf8_encode(ucwords(strtolower($nombre)))?></td>
                ...
                <tr>
                   ...
                   $dire= str_replace ( "Ñ" , "ñ" , $factura->fac_direccion )
                    ?>
                    <td><strong><?php echo 'Dirección:' ?> </strong><?php echo utf8_encode( ucwords(strtolower($dire)))?></td>
